...
from nas_connector.swift.common import fs_utils as fs
from nas_connector.swift.common.exceptions import NotDirectoryError, \
    FileOrDirNotFoundError, NasConnectorFileSystemOSError
...
class TestFsUtils(unittest.TestCase):
    ...
    def test_do_ismount_path_error(self):
        ...
        try:
            with patch("os.lstat", _mock_os_lstat):
                ...
                except NasConnectorFileSystemOSError:
                    pass
                else:
                    self.fail("Expected NasConnectorFileSystemOSError")
        finally:
            shutil.rmtree(tmpdir)
    ...
    def test_do_open_err_int_mode(self):
        try:
            ...
            self.fail("NasConnectorFileSystemOSError expected")
    ...
    def test_do_write_err(self):
        ...
        try:
            ...
            try:
                ...
                os.close(fd1)
        except NasConnectorFileSystemOSError as ose:
    ...
    def test_mkdirs_already_dir(self):
        ...
        try:
            fs.mkdirs(tmpdir)
        except (NasConnectorFileSystemOSError, OSError):
            self.fail("Unexpected exception")
        else:
            pass
        finally:
    ...
    def test_mkdirs_existing_file(self):
        ...
        try:
            ...
            self.fail("Expected NasConnectorFileSystemOSError exception")
        finally:
            os.close(fd)
            shutil.rmtree(tmpdir)
    ...
    def test_dir_empty_err(self):
        ...
        with patch("os.listdir", _mock_os_listdir):
            try:
                ...
                self.fail("NasConnectorFileSystemOSError exception expected")
    ...
    def test_chown_dir(self):
        ...
        try:
            ...
            if buf.st_uid == 0:
                ...
                except NasConnectorFileSystemOSError as ex:
                    if ex.errno != errno.EPERM:
                        self.fail(
                            "Expected NasConnectorFileSystemOSError(errno=EPERM)")
                else:
                    self.fail("Expected NasConnectorFileSystemOSError")
        finally:
            shutil.rmtree(tmpdir)
