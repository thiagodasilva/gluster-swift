...
import pickletools
from nas_connector.swift.common.exceptions import NasConnectorFileSystemIOError, \
    ThreadPoolDead
from swift.common.exceptions import DiskFileNoSpace
from swift.common.db import native_str_keys
from nas_connector.swift.common.fs_utils import do_getctime, do_getmtime, do_stat, \
...
def _update_list(path, cont_path, src_list, reg_file=True, object_count=0,
    ...
    for obj_name in src_list:
        ...
        if not reg_file and not _implicit_dir_objects:
...
def delete_tracker_object(container_path, obj):
    ...
    Called by:
        - nas_connector.swift.obj.expirer.ObjectExpirer.pop_queue()
        - nas_connector.swift.common.DiskDir.DiskDir.delete_object()
    """
