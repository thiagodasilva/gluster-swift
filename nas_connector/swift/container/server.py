...
from nas_connector.swift.common.DiskDir import DiskDir
...
class ContainerController(server.ContainerController):
    ...
    def _get_container_broker(self, drive, part, account, container, **kwargs):
        """
        Overriden to provide the specific broker that talks to the
        NAS share for the information related to servicing a given request
    ...
    def account_update(self, req, account, container, broker):
        ...
        For NAS Connector, this is just a no-op, since an account is just the
